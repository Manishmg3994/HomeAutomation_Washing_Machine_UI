...
import 'package:awsome_project/screens/water_drawer/wave_container.dart';
import 'package:awsome_project/shared/colors.dart';
import 'package:awsome_project/shared/decorators.dart';
        ...
        child: Stack(
          children: [
            WaveContainer(
              ...
              color: const Color.fromARGB(74, 75, 191, 236),
              sinWidthFraction: 2,
            ),
            WaveContainer(
              size: Size(90, widget.height),
